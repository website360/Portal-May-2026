...
import { Blocks, FileText, Globe, LayoutGrid, LifeBuoy, ListTodo, Users, Wallet, Wrench, type LucideIcon } from 'lucide-react';
...
export const navigation: NavLink[] = [
    ...
    { title: 'Tickets', href: '/tickets', icon: LifeBuoy, module: 'tickets' },
